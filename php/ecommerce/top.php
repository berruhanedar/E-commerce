...
<head>
	...
	/* CSS kodunu buraya ekleyin */
        ...
        /* Navigasyon oklarının rengini buraya ekleyin */
        .owl-prev, .owl-next {
        ...
        /* "Login/Register" linkinin stilini güncelle */
        a.mr15 {
            font-family: 'Poppins', sans-serif; /* Yazı tipi */
        ...
        /* Hover durumunda metin rengini güncelle */
        a.mr15:hover {
            color: #b7315b;
        }
